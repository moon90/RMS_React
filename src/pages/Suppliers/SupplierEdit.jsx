...
const SupplierEdit = () => {
    ...
    const fetchSupplier = async () => {
      try {
        ...
        if (response.data.isSuccess) {
          const { supplierName, contactPerson, phone, email, address, status } = response.data.data;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await updateSupplier(id, { id: parseInt(id), supplierName, contactPerson, phone, email, address, status });
  ...
  if (loading) {
    return <div className="p-3 max-w-4xl mx-auto">Loading supplier...</div>;
  }
  ...
  return (
    <div className="p-3 max-w-4xl mx-auto">
      <FormCard>
        <h2 className="text-2xl font-bold mb-6 text-gray-800">Edit Supplier</h2>
